...
public class InterrogationRoomController implements Initializable {
   ...
   @FXML
    ...
    @FXML
    private ImageView evidence_inventory_space_3;
    @FXML
    ...
    private void itemUnlocksPuzzle(ActionEvent event) {
        ...
        if (source == officer_mason_key_button) {
           ...
           paper_button.setVisible(true);
            paper_button.setDisable(false);
        }
    ...
    private void completePuzzle(ActionEvent event) {
        ...
        if (source == correct_button) {
            // Correct answer
            dialog_text.setText("You cracked the code! It wasn't gibberish, it was Officer Mason bragging about his crimes! With this, you should be able to show that he's the corrupt cop! Time to get out of here!");

           

            // Disable cabinet button after puzzle is completed
           paper_button.setDisable(true);

            // Add evidence to inventory
            evidence_inventory_space_3.setVisible(true);
